...
sudo iptables -t nat -A POSTROUTING -p tcp --match multiport --dports  2053,80,443 -j MASQUERADE 
sudo iptables -t nat -A PREROUTING -p tcp --match multiport --dports  2053,80,443 -j DNAT --to-destination $IP
